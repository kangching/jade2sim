...
//				System.out.println(getLocalName() + ": Input: " + input);
				...
				vIn = parseAnswerDouble(input)[5];
				slopeAdj = parseAnswerDouble(input)[15];
				v0Adj = parseAnswerDouble(input)[17];
				iMin = parseAnswerDouble(input)[19];
				iMax = parseAnswerDouble(input)[21];
