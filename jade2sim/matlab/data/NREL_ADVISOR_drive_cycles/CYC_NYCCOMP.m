% ADVISOR data file:  CYC_NYCCOMP.m
%
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='New York City Composite Driving Schedule';
...
disp(['Data loaded: CYC_NYCCOMP - ',cyc_description])
...
% 12/30/99:ss changed all instances of NYCCDS to NYCCCOMP to be consistent and for loading of .mat file.
