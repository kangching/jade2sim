% ADVISOR data file:  CYC_ECE_EUDC_LOW.m
%
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='ECE+EUDC Drive Cycle for Low Power Vehicles';
...
disp(['Data loaded: CYC_ECE_EUDC_LOW - ',cyc_description])
