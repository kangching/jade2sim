% ADVISOR data file:  CYC_1015_6PRIUS.m
%
% Data source:
% ANL Prius Test data on dyno: #6 Jap 10-15 ms120112381.
%
% Data confirmation:
%
% Notes:
% This data represents the Japanese 10-15 mode driving cycle for Prius Test on Dyno at ANL.
% 
% Created on: 22-Jun-2000
% By:  SS of NREL
%
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='Jap. 10-15 Prius test dyno cycle';
...
disp(['Data loaded: CYC_1015_6PRIUS - ',cyc_description])
...
% REVISION HISTORY
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 6/22/00: ss created from cyc_1015, slightly different because using dyno data.
