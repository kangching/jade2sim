...
% both the acceleration and deceleration performance of the vehicle.
% Since a step change in speed in requested it is recommended that this
% cycle be run using a time step of 0.1s.
%
% Created on: 3/24/00
...
disp(['Data loaded: CYC_STEP - ',cyc_description])
...
spd=55; % (mph) constant vehicle speed
cyc_mph=[0	spd; 1 spd; 100 spd; 100+eps 0; 200-eps 0; 200 spd; 300 spd]; % 
