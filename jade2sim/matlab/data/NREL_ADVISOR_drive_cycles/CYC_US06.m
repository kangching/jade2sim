...
%
% Notes:
% This cycle is one of three included in the US EPA's Supplemental Federal Test
% Procedure to be used to measure vehicular tailpipe emissions.  The US06
% includes high speed operation and demanding accelerations.
% 
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='High speed and high acceleration component of SFTP';
...
disp(['Data loaded: CYC_US06 - ',cyc_description])
