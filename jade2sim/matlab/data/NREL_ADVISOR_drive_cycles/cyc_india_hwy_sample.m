% ADVISOR data file:  CYC_INDIA_HWY_SAMPLE.m
%
...
%
% Notes:
% This file contains a sample (unofficial) Indian highway driving cycle, taken 
% on 12-March-2000 for 881 seconds. This cycle is characterised by 
% moderate transients, with lower top speeds.
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='Indian highway driving cycle (sample)';
...
disp(['Data loaded: CYC_INDIA_HWY_SAMPLE - ',cyc_description])
