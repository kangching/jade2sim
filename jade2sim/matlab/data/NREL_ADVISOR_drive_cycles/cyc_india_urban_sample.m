% ADVISOR data file:  CYC_INDIA_URBAN_SAMPLE.m
%
% Data source: Arun Rajagopalan, based on a study in Madras, India on 12-March-2000.
%
% Data confirmation:
%
% Notes:
% This file contains a sample (unofficial) Indian Urban driving cycle, taken 
% on 12-March-2000 for 2689 seconds. This cycle is characterised by 
% frequent starts and stops, with lower top speeds.

% Created on: 15-Aug-2001
% By:  AR of NREL
%
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cyc_description='Indian urban driving cycle (sample)';
...
disp(['Data loaded: CYC_INDIA_URBAN_SAMPLE - ',cyc_description])
...
load CYC_INDIA_URBAN_SAMPLE.mat
